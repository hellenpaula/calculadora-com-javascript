...
## 📌 Sobre:
Este é um projeto de calculadora funcional desenvolvida com HTML, CSS e JavaScript puro, criado com o objetivo de praticar lógica de programação, manipulação do DOM e controle de fluxo em aplicações interativas.
A proposta foi construir uma calculadora capaz de realizar operações matemáticas simples (adição, subtração, multiplicação e divisão), com suporte a números decimais e uma interface limpa e intuitiva.
...
## 🧠 Aprendizados:
Durante o desenvolvimento deste projeto, foram praticados e reforçados conceitos fundamentais de programação e lógica, como:

- Estruturação e controle de fluxos condicionais (if, else if, else).

- Manipulação de eventos e estados com variáveis de controle.

- Concatenar e atualizar dinamicamente o display da interface via DOM.
...
## 🚀 Melhorias futuras:
- Permitir entrada de valores diretamente pelo teclado (eventos de teclado).
